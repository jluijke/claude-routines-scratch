...
// --- the future -------------------------------------------------------------
//
// The same voices, one twist: a sawtooth lead, which the era's chip did not
// have and which is what makes a tune sound like a synthesiser. Under it the
// same detuned square pair and triangle bass as the land, so the ship still
// sounds like the same game.

/** Driving and bright, in E minor, for the decks of the ship. */
const SHIP: Track = {
  tempo: 140,
  voices: [
    {
...
/** Slow and airless, for the rocks and the airlocks: a low drone and a far-off ping. */
const ROCK: Track = {
  tempo: 84,
  voices: [
    {
...
/** Fast and mechanical, for a mech's core: a hammering riff and a siren over it. */
const MECH: Track = {
  tempo: 168,
  voices: [
    {
