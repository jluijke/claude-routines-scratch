...
const GATE_LIST: Gate[] = [
  ...
  ...[
    ...
    ['brighton', 'The turnstile at Brighton Beach. Sand in the reader. Three words, and it clunks.'],
    ['coney', 'The last turnstile on the line, at Coney Island. It smells of hot dogs. Three words.'],
  ].map(([key, message]) => ({
