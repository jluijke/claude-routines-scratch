...
const AUTHORED: Screen[] = [
  ...
  },
  {
    ...
    exits: { up: 'forest-2' },
    gates: [
      { gateId: 'village-chest', col: 3, row: 7 },
      // In the mouth of the rock pocket he arrives in: the field, the chest and
      // the bushes are all on the far side of him.
      { gateId: 'forest-hermit', col: 7, row: 4, opens: [{ col: 7, row: 4 }, { col: 8, row: 4 }] },
    ],
    spawns: [
  ...
  },
  {
    ...
    gates: [
      { gateId: 'forest-seal-3', col: 7, row: 8, opens: [{ col: 7, row: 8 }, { col: 8, row: 8 }], guards: 'down' },
  ...
  // ------------------------------------------------------------------ river
  {
    ...
    gates: [
      ...
      { gateId: 'ferryman', col: 7, row: 6, opens: [{ col: 7, row: 6 }, { col: 8, row: 6 }], guards: 'up' },
    ],
    props: [{
        sprite: 'scribe',
        col: 11,
    ...
    spawns: [{ kind: 'shooter', col: 5, row: 8 }],
  },
  {
    id: 'river-bridge',
    name: 'The Crossing',
  ...
  },
  {
    ...
    // Behind the falling water, where the seal opens onto.
    treasure: {
      id: 'waterfall-cache',
      col: 12,
      row: 1,
      rupees: 90,
      message: 'A chest in the dry hollow behind the waterfall, where nobody looks.',
    },
  ...
  },
  {
    ...
    // The stair the lantern lights: a nook in the corner with a chest in it.
    treasure: {
      id: 'd1-stair-cache',
      col: 1,
      row: 8,
      rupees: 70,
      message: 'At the foot of the stair, a chest the guardian never noticed.',
    },
  ...
  },
  {
    ...
    gates: [
      ...
      // Right under the door to the approach, so the seven seals are the only way to it.
      { gateId: 'd2-door-3', col: 11, row: 1, opens: [{ col: 11, row: 1 }, { col: 12, row: 1 }] },
    ],
    portals: [
  ...
  },
  {
    ...
    portals: [
      { col: 7, row: 10, to: 'd2-hall', spawnCol: 11, spawnRow: 2 },
  ...
  },
  {
    ...
    // The mural's missing word opens a nook in the corner, with a chest in it.
    treasure: {
      id: 'd2-mural-cache',
      col: 1,
      row: 8,
      rupees: 80,
      message: 'Behind the mural, a chest that was painted over a very long time ago.',
    },
  ...
  },
  {
    ...
    exits: {},
    gates: [{ gateId: 'd4-door-2', col: 11, row: 1, opens: [{ col: 11, row: 1 }, { col: 12, row: 1 }] }],
    portals: [
  ...
  },
  {
    ...
    portals: [
      { col: 7, row: 10, to: 'd4-hall', spawnCol: 11, spawnRow: 2 },
